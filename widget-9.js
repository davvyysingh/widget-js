...
(function () {
  ...
  var css = [
    ...
    '.nai-dots{display:inline-flex;align-items:center;gap:4px;background:#1a1d27;border:1px solid rgba(255,255,255,0.07);padding:10px 14px !important;border-radius:16px;border-bottom-left-radius:4px;}',
