...
(function () {
  ...
  var css = [
    ...
    '#nai-close{background:rgba(0,0,0,0.15);border:none;cursor:pointer;color:'+textOnColor+';width:28px;height:28px;border-radius:50%;display:flex;align-items:center;justify-content:center;flex-shrink:0;transition:background .15s;}',
    '#nai-close:hover{background:rgba(0,0,0,0.3);}',

    // Messages area
    '#nai-msgs{flex:1;overflow-y:auto;padding:16px;display:flex;flex-direction:column;gap:10px;scroll-behavior:smooth;}',
    '#nai-msgs::-webkit-scrollbar{width:4px;}',
    '#nai-msgs::-webkit-scrollbar-thumb{background:rgba(255,255,255,0.1);border-radius:4px;}',

    // Bubbles
    '.nai-row{display:flex;gap:8px;}',
    '.nai-row.nai-user{justify-content:flex-end;}',
    '.nai-bubble{max-width:78%;padding:10px 13px;border-radius:16px;font-size:13.5px;line-height:1.5;word-break:break-word;}',
    '.nai-bubble.nai-bot{background:#1a1d27;border:1px solid rgba(255,255,255,0.07);color:#e2e8f0;border-bottom-left-radius:4px;}',
    '.nai-bubble.nai-user{background:'+C.color+';color:'+textOnColor+';border-bottom-right-radius:4px;font-weight:500;}',

    // Markdown inside bubbles
    '.nai-p{margin-bottom:4px;line-height:1.55;}.nai-p:last-child{margin-bottom:0;}',
    ...
    '.nai-ul{padding-left:18px;margin:4px 0 6px;list-style:disc;}',
    '.nai-ol{padding-left:18px;margin:4px 0 6px;list-style:decimal;}',
    '.nai-ul li,.nai-ol li{margin-bottom:1px;line-height:1.5;}',
  ...
  function sendMessage(text) {
    ...
    botRow.className  = 'nai-row';
    botRow.dataset.id = msgId;
    var botBubble = document.createElement('div');
    botBubble.className = 'nai-bubble nai-bot';
