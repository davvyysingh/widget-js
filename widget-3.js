...
(function () {
  ...
  function renderMarkdown(raw) {
    ...
    text = text.replace(/(<li>[\s\S]*?<\/li>)/g, function(block) {
      return '<ul class="nai-ul">'+block+'</ul>';
    });
  ...
  var css = [
    ...
    '.nai-p{margin-bottom:6px;}.nai-p:last-child{margin-bottom:0;}',
    ...
    '.nai-ul{padding-left:16px;margin:4px 0;list-style:disc;}',
    '.nai-ul li{margin-bottom:2px;}',
