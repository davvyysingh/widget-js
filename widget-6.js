...
(function () {
  ...
  var css = [
    ...
    '.nai-bubble{padding:10px;border-radius:16px;font-size:13.5px;line-height:1.55;word-break:break-word;}',
    ...
    '.nai-ul{padding-left:18px;margin:4px 0 6px 8px;list-style:disc;}',
